...
function Navbar() {
  ...
  const handleNotificationOver = () => {
    setIsNotificationHovered(true);
  };

  const handleNotificationOut = () => {
  ...
  return (
    ...
    >
      <div className="navbar-left-icon-group">
        ...
        {minimizeNavbar && (
          <>
            <a
              onClick={() => {
                setIsBrowsePressed(!isBrowsePressed);
              }}
              className="browse-link"
            >
              Browse
            </a>
            {isBrowsePressed && <BrowseMenu />}
          </>
        )}
      </div>
      ...
      <div className="navbar-right-icon-group">
        ...
        {!isSearchbarFocused && !navIconsDisappear && (
          <span>
            <svg
        ...
        {!navIconsDisappear && (
          <span
            ...
            onMouseOver={handleNotificationOver}
            onMouseOut={handleNotificationOut}
          >
            <svg
