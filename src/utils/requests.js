...
const requests = {
  ...
  arrivals:
    baseUrl +
    `/discover/tv?api_key=${API_KEY}&first_air_date.gte=${new Date(
      ...
      .slice(
        0,
        10
      )}&first_air_date.lte=${currentDate}&language=en-US&region=US&sort_by=popularity.desc&page=1&with_origin_country=US`,
};
